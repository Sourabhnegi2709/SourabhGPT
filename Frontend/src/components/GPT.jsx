...
const GPT = ({ links, children, className }) => {
            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md border bg-transparent shadow-lg dark:bg-zinc-900 dark:border-zinc-700"
                    >
                        <div className="py-1">
